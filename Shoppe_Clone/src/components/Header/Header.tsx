...
export default function Header() {
  ...
  const logoutMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setProfile(null)
      // logout sẽ clear data trên React Query, không gọi api nữa
  ...
  // Nên các query này sẽ không bị inactive (không có Component nào Subscrice đến query đó nữa) => Không bị gọi lại => không cần thiết phải set stale: Infinity
                ...
                <div className='relative  max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  {purchasesInCart && purchasesInCart.length > 0 ? (
                    ...
                    <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                      <img src={notproduct} alt='not purchase' className='h-24 w-24' />
