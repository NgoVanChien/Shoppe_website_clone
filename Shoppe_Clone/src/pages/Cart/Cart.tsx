...
interface ExtenPurchases extends Purchase {
  disabled: boolean
  checked: boolean
}

export default function Cart() {
  const [extendPurchases, setExtendPurchases] = useState<ExtenPurchases[]>([])
      ...
      <div className='container'>
        ...
        <div className='sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'>
          <div className='flex items-center'>
            ...
            <button className='mx-3 border-none bg-none'>Chọn tất cả({extendPurchases.length})</button>
          ...
          <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
            <div>
              ...
              <div className='flex items-center text-sm sm:justify-end'>
                ...
                <div className='ml-6 text-orange'>₫13800</div>
              </div>
            </div>
